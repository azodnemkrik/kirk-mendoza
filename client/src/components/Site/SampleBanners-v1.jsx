		...
		<>
			<div id={id} className={`centered-container ${className}`}>
				...
				<div className="banners-container2 section-container">
					...
					<p>
						<span className="h2-style light-blue"> Every banner ad </span><br />is built from the ground up with attention to detail and optimized to 200K <i>(unless otherwise allotted)</i>. I avoid tools that generate unnecessary bloat but rather hand-code animations with GSAP resulting in work that feels premium, intentional, and anything but cookie-cutter.
					</p>
