...
(function () {
	gsap.set(".motion-path", { x: 100, y: 290, scaleX: 2.2, scaleY: 1.5 });
	...
	maintl
		...
		.set( ".frame2-container, .ground2, .ui2, .endframe-container, .background2", { autoAlpha: 0 }, "frame0")
		...
		.set( ".frame1-container, .icons-container, .text1, .white-ellipse", { autoAlpha: 0 }, "frame2+=.3")
		...
		.from(text3.chars, 0.01, { autoAlpha: 0, stagger: 0.08 }, "frame4+=1")
		// .from(text4.chars, 0.01, { autoAlpha: 0, stagger: 0.0065 }, "frame4+=.5")

		// // Frame 5
		.add("frame5", "+=1")
		.set(".frame1-container, .endframe-container", { autoAlpha: 1, scale: 1 },"frame5")
		...
		.to(".background2", 1, { x: -300, ease: Power2.easeInOut }, "frame5")
		.from(".icon-end", 0.75, { x: 300, stagger: 0.05, ease: Power2.easeInOut },"frame5+=.25")
