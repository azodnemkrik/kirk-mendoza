...
const bannerSize = { width:"300" , height: "600"};
let pixelate = false;
...
(function () {
  ...
  // currentCount determines which video is in the center
    ...
    gsap.to (centerVid , .5, { x: centerPosition , ease: Power1.easeInOut,      
      onStart: function() {
        isAnimating = true
        leftVid.pause()
        rightVid.pause()
    ...
    gsap.to (centerVid , .5, { scale: 1 , zIndex: 100 , ease: Back.easeOut , delay: .45 , boxShadow: "0px 10px 10px 0px rgba(0, 0, 0, 0.55)",
      onComplete: function() {
        isAnimating = false
        centerVid.play()
      }
  ...
  maintl
    ...
    .from(".doomLogo" , 2 ,{ scale: .9 , ease: Power0.easeNone}, "frame0")
    ...
    .to(".green_shape", .8 , { autoAlpha: 1 , scaleX :1.6 , ease: Power1.easeOut }, "frame1+=.3")
    .from(".cta-button", .8 , { autoAlpha: 0 , y :25 , ease: Power1.easeOut }, "frame1+=.75")

    // Frame 2
    .add("frame2", 1.5)
    .from(".carouselVid", 2, { x: "+=1500", ease: Power4.easeInOut } , "frame2")
    .set (centerVid , { zIndex: 21 } , "frame3")
    .to (centerVid , .5, { scale: 1 , ease: Back.easeOut , boxShadow: "0px 10px 10px 0px rgba(0, 0, 0, 0.55)",
      onComplete: function() {
        isAnimating = false;
        toggleAutoplay(autoPlay)
        centerVid.play()
  ...
  // Arrow CTA Animation
    ...
    tlCta
      ...
      .to(".cta-button" , .35, { scale: 1.1 , ease: Power2.easeInOut} , "frame1")
