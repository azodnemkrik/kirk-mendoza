...
function createAnimation() {
    tl1 = gsap.timeline()
        ...
        .set('.portal' , {autoAlpha: 0 } , "<")

        .to('#intro', { duration: 0.01, z: 1, x: "0", alpha: 0, ease: "power2.out" }, "<1.5")
        // .to('#disclaimerintro', { duration: 0.1, z: 1, x: "0", alpha: 0, ease: "power2.out" }, "<")
        .to('#introesbr, #introesbr2', { duration: 0.1, z: 1, x: "0", alpha: 0, ease: "power2.out" }, "<")

        .to('#mg', { duration: 0.4, z: 1, alpha: 1, ease: "power2.out" }, "<")
        ...
        .to('#efg', { duration: 0.8, z: 1, x: "0", alpha: 1, ease: "power1.out" }, "<4.5")
        .to('#mg', { duration: 0.8, z: 1, x: "0", alpha: 0, ease: "power1.out" }, "<")
        .to('#logo', { duration: 0.4, z: 1, fill: "#2f2f2f" }, "<")
        // .to('#headline1', { duration: 0.4, z: 1, color: "#2f2f2f" }, "<")
        .fromTo('#headline1, #headline2 ', { color: "#ffffff" }, { duration: 0.4, z: 1, color: "#2f2f2f" }, "<")
        .fromTo('#esrbtxt, #disclaimer', { color: "#ffffff" }, { duration: 0.4, z: 1, color: "#000000" }, "<")
        .set('.flash-cover' , {autoAlpha: 1 } , "<.3")
        .to('.flash-cover', .5 , { autoAlpha: 0 , ease: "power1.out" }, "<")
        ...
        .fromTo('.bg', 1.5 , { scale: 3 } , { scale:1  , ease:Power4.easeOut  }, "-=4")
        .fromTo('#anim2' , 1.5,  { alpha: 0 , scale:.5 , zIndex:-1, attr:{borderRadius: 300}} , {alpha: 1 , scale:1 , zIndex: 0 , attr:{borderRadius: 0}, ease:Power4.easeOut , onStart: function(){
            if (playedOnce == false) {
                playLoop(false)
            } else {
                playLoop(true)
    ...
    tlZoom
        .to('#anim2' , 1,  { scale:1.2 , x: -25 , y: -20 , ease: "power1.inOut"})
        .pause();
        // .to(vid2, { duration: 1, z: 1, scale: 1.2, y: "+=30", x: "-=15", ease: "power1.inOut" })
        // .pause();
        ...
        .fromTo('.leaf7', 3 , { x:-20 , rotation: 0 }, { x: 50 ,rotation: 20 , ease: Power1.easeOut, transformOrigin:"50% 50%"}, "leaf7")
        .seek(0)
        // .pause();
        ...
        leavesLargetl
        .add("leavesLarge" , 0)
        .fromTo('.largeLeaf1', 4 , { x: -40 , y: 170 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 350 , y: -150 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge")
        .fromTo('.largeLeaf2', 3 , { x: -50 , y: 160 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 360 , y: -50 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge+=1")
        .fromTo('.largeLeaf3', 4 , { x: -55 , y: 200 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 350 , y: 50 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge+=3")
        .fromTo('.largeLeaf4', 2 , { x: -150 , y: 220 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 357 , y: 75 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge+=3.5")
        .fromTo('.largeLeaf5', 5 , { x: -70 , y: 144 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 370 , y: -100 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge+=6")
        .fromTo('.largeLeaf6', 2.5 , { x: -100 , y: 100 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() * -1  , rotationZ: randomAngle() } , { x: 365 , y: 250 , scale: 1.5 , rotationX: randomAngle() , rotationY: randomAngle() , rotationZ: randomAngle() , ease: Power1.easeIn, transformOrigin:"50% 50%" } , "leavesLarge+=8")
      
        // Dirt
        dirttl
        .add("dirt1", 0)
        .from('.dirt1', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt1")
        .fromTo('.dirt1', 4 , { x: 300 , y: 120 , scale: .5 , rotation: -40} , { x: 550 , y: -20 , scale: 1 , rotation: -240 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt1")
        .to('.dirt1', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt1+=3")
      
        .add("dirt2", 1)
        .from('.dirt2', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt2")
        .fromTo('.dirt2', 5 , { x: 250 , y: 120 , scale: 1 , rotation: -40 } , { x: 500 , y: -50 , scale: .25 , rotation: -240 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt2")
        .to('.dirt2', .5 , { autoAlpha: 0 , stagger: .1 }, "dirt2+=3.5")
      
        .add("dirt3", 3)
        .from('.dirt3', 1 , { autoAlpha: 0 , stagger: .15}, "dirt3")
        .fromTo('.dirt3', 5 , { x: 200 , y: 220 , scale: .25 , rotation: -40 } , { x: 500 , y: -50 , scale: .75 , rotation: -270 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .15}, "dirt3")
        .to('.dirt3', .5 , { autoAlpha: 0 , stagger: .15}, "dirt3+=3.5")
      
        .add("dirt4", 5)
        .from('.dirt4', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt4")
        .fromTo('.dirt4', 5 , { x: 300 , y: 350 , scale: .45 , rotation: -40 } , { x: 600 , y: -150 , scale: .65 , rotation: -290 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt4")
        .to('.dirt4', .5 , { autoAlpha: 0 , stagger: .1 }, "dirt4+=3.5")
      
        .add("dirt5", 7)
        .from('.dirt5', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt5")
        .fromTo('.dirt5', 5 , { x: 220 , y: 250 , scale: .45 , rotation: -40 } , { x: 500 , y: -100 , scale: .65 , rotation: -260 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt5")
        .to('.dirt5', .5 , { autoAlpha: 0 , stagger: .1 }, "dirt5+=3.5")
      
        .add("dirt6", 9)
        .from('.dirt6', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt6")
        .fromTo('.dirt6', 5 , { x: 260 , y: 300 , scale: .75 , rotation: -40 } , { x: 600 , y: -100 , scale: .25 , rotation: -260 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt6")
        .to('.dirt6', .5 , { autoAlpha: 0 , stagger: .1 }, "dirt6+=3.5")
      
        .add("dirt7", 10)
        .from('.dirt7', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt7")
        .fromTo('.dirt7', 5 , { x: 160 , y: 300 , scale: .75 , rotation: -40 } , { x: 600 , y: -100 , scale: .25 , rotation: -260 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt7")
        .to('.dirt7', .5 , { autoAlpha: 0 , stagger: .1 }, "dirt7+=3.5")
      
        .add("dirt8", 11)
        .from('.dirt8', 1 , { autoAlpha: 0 , stagger: .1 }, "dirt8")
        .fromTo('.dirt8', 5 , { x: 222 , y: 322 , scale: .75 , rotation: -40 } , { x: 600 , y: -100 , scale: .25 , rotation: -260 , ease: Power0.easeNone, transformOrigin:"0% 100%", stagger: .1 }, "dirt8")
        ...
        .fromTo('.smoke1', 6 , { x: 50 , y: 120 , scale: 1 , rotation: -0} , { x: 350 , y: 100 , scale: 2 , rotation: 40 , ease: Power0.easeNone, transformOrigin:"50% 50%" }, "smoke1")
        .to('.smoke1', 1 , { autoAlpha: 0 }, "smoke1+=5")
      
        .add("smoke2", .5)
        .fromTo('.smoke2', 1 , { autoAlpha: 0 }, { autoAlpha: .2 }, "smoke2")
        .fromTo('.smoke2', 6 , { x: 50 , y: 120 , scale: 3 , rotation: -0} , { x: 350 , y: 100 , scale: 2.5 , rotation: 110 , ease: Power0.easeNone, transformOrigin:"50% 50%" }, "smoke2")
        .to('.smoke2', 1 , { autoAlpha: 0 }, "smoke2+=5")
      
        .add("smoke3", 2)
        .fromTo('.smoke3', 1 , { autoAlpha: 0 }, { autoAlpha: .2 }, "smoke3")
        .fromTo('.smoke3', 6 , { x: 0 , y: -120 , scale: 3 , rotation: -0} , { x: 350 , y: -100 , scale: 2.5 , rotation: -110 , ease: Power0.easeNone, transformOrigin:"50% 50%" }, "smoke3")
        ...
        .fromTo('.smoke4', 6 , { x: 200 , y: -0 , scale: 5 , rotation: 0} , { x: 600 , y: 0 , scale: 5 , rotation: 60 , ease: Power0.easeNone, transformOrigin:"50% 50%" }, "smoke4")
      
        .add("smoke5", 0)
        .fromTo('.smoke5', 1 , { autoAlpha: 0 }, { autoAlpha: .25 }, "smoke5")
        .fromTo('.smoke5', 6 , { x: -200 , y: -0 , scale: 5 , rotation: -60} , { x: 200 , y: 0 , scale: 5 , rotation: 0 , ease: Power0.easeNone, transformOrigin:"50% 50%" }, "smoke5")
        // .to('.smoke4', 1 , { autoAlpha: 0 }, "smoke4+=5")
        .seek(0)
        // .pause();
      
        swordtl
        // .add("sword", 0)
        // .set('.white-glare' , { x: -120 , scaleX: 2 , rotation: -50 , autoAlpha: .7} , "sword")
        // .to('.white-glare', 4 , { x: 105 , scaleX:.5 , rotation: 50 , autoAlpha: 0 , delay: 3 , ease: Power1.easeInOut}, "sword+=0")
        // .seek(0)
        // .pause();
...
function playLoop(aBoolean) {
    ...
    if(aBoolean == false){
        gsap.to(vid1, 6 , { alpha: 1 , onComplete: function(){
