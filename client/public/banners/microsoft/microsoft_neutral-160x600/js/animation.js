...
(function () {
	gsap.set(".motion-path", { x: 32, y: 185, scaleX: 1.2, scaleY: 0.85 });
	...
	maintl
		...
		.from(".frame-3-ui-2, .frame-3-ui-1", 0.5, { scale: .75, autoAlpha: 0 , stagger: 0.15, ease:Back.easeOut}, "frame4+=.25")
		.from(text3.chars, 0.01, { autoAlpha: 0, stagger: 0.07 }, "frame4+=1.05")
